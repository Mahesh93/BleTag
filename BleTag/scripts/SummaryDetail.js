(function (global) {
    ...
    var SummaryDetailDataModel = kendo.data.ObservableObject.extend({
        ...
        summaryDetailMenuDataSource: null,
        init: function (e) {
            var that = this,
                dataSource,
                jsonUrlToLoad;
            ...
            var summaryDetailMenuDataSource = new kendo.data.DataSource({
                schema: {
            ...
            that.set("summaryDetailMenuDataSource", summaryDetailMenuDataSource);
        }
    });
    app.summaryDetailService = {
        ...
        menuClick: function (item) {
            ...
            switch (menuId) {
                case 1:
                    app.BleTag.main.navigate('views/CoolerDataList.html');
                    break;
                case 2:
                    app.BleTag.main.navigate('views/CoolerImageList.html');
                    break;
                case 3:
                    break;
                default:
